        ...
        for yCoordinate in range(0, self.blockDimension):  # compute the part 1 and part 2 of each feature characteristic
            for xCoordinate in range(0, self.blockDimension):
                ...
                if yCoordinate <= self.blockDimension / 2:
                    c4_part1 = c4_part1+ self.imageGrayscalePixels[xCoordinate, yCoordinate]
                else:
                    c4_part2 =c4_part2+ self.imageGrayscalePixels[xCoordinate, yCoordinate]
                # compute c5
                if xCoordinate <= self.blockDimension / 2:
                    c5_part1 =c5_part1+ self.imageGrayscalePixels[xCoordinate, yCoordinate]
                else:
                    c5_part2 =c5_part2+ self.imageGrayscalePixels[xCoordinate, yCoordinate]
                # compute c6
                if xCoordinate - yCoordinate >= 0:
                    c6_part1 =c6_part1 +self.imageGrayscalePixels[xCoordinate, yCoordinate]
                else:
                    c6_part2 =c6_part2+ self.imageGrayscalePixels[xCoordinate, yCoordinate]
                # compute c7
                if xCoordinate + yCoordinate <= self.blockDimension:
                    c7_part1 =c7_part1+ self.imageGrayscalePixels[xCoordinate, yCoordinate]
                else:
                    c7_part2 =c7_part2+ self.imageGrayscalePixels[xCoordinate, yCoordinate]
